...
// -------------------------------------------------------------------------
// -----                    FccFieldPar header file                  -----
// -----                Created 26/03/14  by M. Al-Turany              -----
// -------------------------------------------------------------------------



#ifndef FccFieldPar_H
#define FccFieldPar_H 1
...
class FccFieldPar : public FairParGenericSet
{
 ...
 public:
  ...
  FccFieldPar(const char* name, const char* title, const char* context);
...
/** default constructor  **/
 ...
 private:
  ...
  FccFieldPar(const FccFieldPar&);
  FccFieldPar& operator=(const FccFieldPar&);

  ClassDef(FccFieldPar,1);
