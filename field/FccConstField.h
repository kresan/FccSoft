...
#ifndef FccConstField_H
#define FccConstField_H 1
...
class FccConstField : public FairField
{
 ...
 public:    
   ...
   **/
  FccConstField(const char* name, Double_t xMin, Double_t xMax,
		Double_t yMin, Double_t yMax, Double_t zMin,
		Double_t zMax, Double_t bX, Double_t bY, Double_t bZ);


  /** Constructor from FccFieldPar **/
  FccConstField(FccFieldPar* fieldPar);


  /** Destructor **/
  virtual ~FccConstField();
