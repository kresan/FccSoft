...
FccConstField::FccConstField(const char* name, Double_t xMin, 
...
FccConstField::FccConstField(FccFieldPar* fieldPar)
  : FairField(),
    fXmin(0.),   
    fXmax(0.),
    fYmin(0.),
...
{
  if ( ! fieldPar ) {
    cerr << "-W- FccConstField::FccConstField: empty parameter container!"
	 << endl;
    fType=0;
  }
  else {
...
// -----   Set field region   ----------------------------------------------
void FccConstField::SetFieldRegion(Double_t xMin, Double_t xMax, 
...
// -----   Set field values   ----------------------------------------------
void FccConstField::SetField(Double_t bX, Double_t bY, Double_t bZ) {
  fBx   = bX;
  fBy   = bY;
  fBz   = bZ;
}
...
Double_t FccConstField::GetBx(Double_t x, Double_t y, Double_t z) {
  if ( x < fXmin  ||  x > fXmax  ||
       y < fYmin  ||  y > fYmax  ||
...
Double_t FccConstField::GetBy(Double_t x, Double_t y, Double_t z) {
  if ( x < fXmin  ||  x > fXmax  ||
       y < fYmin  ||  y > fYmax  ||
       z < fZmin  ||  z > fZmax ) return 0.;
  return fBy;
...
Double_t FccConstField::GetBz(Double_t x, Double_t y, Double_t z) {
  if ( x < fXmin  ||  x > fXmax  ||
       y < fYmin  ||  y > fYmax  ||
       z < fZmin  ||  z > fZmax ) return 0.;
  return fBz;
