...
ClassImp(FccPassiveContFact)

static FccPassiveContFact gFccPassiveContFact;

FccPassiveContFact::FccPassiveContFact()
  : FairContFact()
{
  // Constructor (called when the library is loaded)
  fName="FccPassiveContFact";
  fTitle="Factory for parameter containers in libPassive";
  setAllContainers();
  FairRuntimeDb::instance()->addContFactory(this);
}

void FccPassiveContFact::setAllContainers()
{
...
FairParSet* FccPassiveContFact::createContainer(FairContainer* c)
{
