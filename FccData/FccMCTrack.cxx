...
FccMCTrack::FccMCTrack(Int_t pdgCode, Int_t motherId, Double_t px,
...
// -----   Copy constructor   ----------------------------------------------
FccMCTrack::FccMCTrack(const FccMCTrack& track)
  : TObject(track),
...
FccMCTrack::FccMCTrack(TParticle* part)
  : TObject(),
...
// -----   Public method Print   -------------------------------------------
void FccMCTrack::Print(Int_t trackId) const
{
...
Double_t FccMCTrack::GetMass() const
{
...
Double_t FccMCTrack::GetRapidity() const
{
...
Int_t FccMCTrack::GetNPoints(DetectorId detId) const
{
...
void FccMCTrack::SetNPoints(Int_t iDet, Int_t nPoints)
{
/*
  if ( iDet == kREF ) {
