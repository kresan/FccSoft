 ...
 ** are copied to a FccMCTrack array, which is stored in the output.
 **
...
class FccStack : public FairGenericStack
{
  ...
  private:
    ...
    FccStack(const FccStack&);
    FccStack& operator=(const FccStack&);
